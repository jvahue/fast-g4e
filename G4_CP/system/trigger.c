...
UINT16 TriggerGetSystemHdr ( void *pDest, UINT16 nMaxByteSize )
{
         ...
         TriggerIndex++ )
   {
      ...
      TriggerHdr[TriggerIndex].SensorIndexA = m_TriggerCfg[TriggerIndex].TrigSensor[0].SensorIndex;
      TriggerHdr[TriggerIndex].SensorIndexB = m_TriggerCfg[TriggerIndex].TrigSensor[1].SensorIndex;
      TriggerHdr[TriggerIndex].SensorIndexC = m_TriggerCfg[TriggerIndex].TrigSensor[2].SensorIndex;
      TriggerHdr[TriggerIndex].SensorIndexD = m_TriggerCfg[TriggerIndex].TrigSensor[3].SensorIndex;
