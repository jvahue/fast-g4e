...
#pragma pack(1)
typedef struct {
  INT8          Phone[MSSC_CFG_STR_MAX_LEN];     
  MSCP_GSM_MODE Mode; 
  INT8          APN[MSSC_CFG_STR_MAX_LEN];
  INT8          User[MSSC_CFG_STR_MAX_LEN];
  INT8          Password[MSSC_CFG_STR_MAX_LEN];
  INT8          Carrier[MSSC_CFG_STR_MAX_LEN];
  INT8          MCC[MSSC_CFG_STR_MAX_LEN];
  INT8          MNC[MSSC_CFG_STR_MAX_LEN];
} MSSC_GSM_CONFIG;
#pragma pack()
...
typedef struct {
  FLT_STATUS PBITSysCond;         // PBIT Status
  FLT_STATUS CBITSysCond;         // CBIT Status
