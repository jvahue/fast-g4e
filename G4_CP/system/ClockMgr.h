...
/******************************************************************************
  ...
  VERSION
      $Revision: 25 $  $Date: 9/03/14 5:15p $
...
#define CM_TICK_TIMEOUT(startTime, timeOut) ((CM_GetTickCount() - startTime) > timeOut)
...
EXPORT void      CM_UpdateRecordingState(BOOLEAN bRec);
 ...
 *
 * *****************  Version 22  *****************
 * User: John Omalley Date: 3/10/14    Time: 4:33p
 * Updated in $/software/control processor/code/system
 * SCR 1065 - Added CM Tick timeout MACRO.
 *
 * *****************  Version 21  *****************
