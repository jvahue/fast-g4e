...
//*********************************************************************************************
#define STABILITY_RANGE_DEFAULT 0.f,  /* Lower value */\
                                0.f,  /* Upper value */\
                                0.f   /* Variance    */


#define STABILITY_CRITERIA_DEFAULT SENSOR_UNUSED,          /* SensorIndex*/\
                                   STABILITY_RANGE_DEFAULT /* Criteria   */

#define STABILITY_DEFAULT   STABILITY_CRITERIA_DEFAULT,/* Stability */\
                            STABILITY_CRITERIA_DEFAULT,\
                            STABILITY_CRITERIA_DEFAULT,\
                            STABILITY_CRITERIA_DEFAULT,\
                            STABILITY_CRITERIA_DEFAULT,\
                            STABILITY_CRITERIA_DEFAULT,\
