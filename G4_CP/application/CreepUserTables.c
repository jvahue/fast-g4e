...
USER_MSG_TBL CreepObjectSenRowTbl[] = 
{
  ...
  {"SAMPLERATE", NO_NEXT_TABLE, CreepMsg_ObjRow, USER_TYPE_UINT16,  USER_RW, 
...
USER_MSG_TBL CreepObjectSenColTbl[] = 
{
  ...
  {"SAMPLERATE", NO_NEXT_TABLE, CreepMsg_ObjCol, USER_TYPE_UINT16,  USER_RW, 
                 (void *) &CreepCfgObjSenTemp.sampleRate_ms, 0, CREEP_MAX_OBJ-1, NO_LIMIT, NULL},
...
USER_MSG_TBL CreepObjectTbl[] = 
{
  ...
  {"RATE", NO_NEXT_TABLE, CreepMsg_Object, USER_TYPE_ENUM,  USER_RW, 
...
USER_MSG_TBL CreepCfgTbl[] = 
{
  ...
  {"BASEUNITS(1En)", NO_NEXT_TABLE, CreepMsg_Cfg,  USER_TYPE_UINT16,  USER_RW, 
                                   ...
                                   void **GetPtr)
{
  ...
  {
    result = USER_RESULT_OK;
    GSE_DebugStr(NORMAL,TRUE, "Creep Data Cleared");
