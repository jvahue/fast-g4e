...
/******************************************************************************
  ...
  Description: Discrete Input and Output driver.  This module maintains
   ...
   VERSION
   $Revision: 47 $  $Date: 12-08-16 4:17p $
...
*
*
* Parameters:  [in] Discrete Output value to be returned.
*              [out]Boolean value of the output pin
*
*
* Returns:     None
*
...
*
* Parameters:  [in] pointer to a discrete input data port.
*
*
