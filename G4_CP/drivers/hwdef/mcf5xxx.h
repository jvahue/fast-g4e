...
typedef volatile UINT32 vuint32 ; //Base the volatile unsigned
typedef volatile UINT16 vuint16;  //used in all these Freescale HW def
typedef volatile UINT8 vuint8;    //files on Altair's basic type
