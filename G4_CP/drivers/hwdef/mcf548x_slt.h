...
#define MCF_SLT_SLTCNT(x)    (*(vuint32*)(void*)(&__MBAR[0x000900+((x)*0x010)]))
#define MCF_SLT_SCR(x)       (*(vuint32*)(void*)(&__MBAR[0x000904+((x)*0x010)]))
#define MCF_SLT_SCNT(x)      (*(vuint32*)(void*)(&__MBAR[0x000908+((x)*0x010)]))
#define MCF_SLT_SSR(x)       (*(vuint32*)(void*)(&__MBAR[0x00090C+((x)*0x010)]))
