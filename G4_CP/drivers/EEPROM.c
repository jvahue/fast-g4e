...
/******************************************************************************
  ...
  Description: Device driver for the Microchip 25AA1024/25LC1024
   ...
   VERSION
    $Revision: 26 $  $Date: 12-11-02 11:47a $
...
*
* Parameters:  [in]  Addr - EEPROM Address
*
*              [out] Device - *Pointer to EEPROM SPI_DEV in which the address is located
*
*
*
 ...
 * 
 * *****************  Version 26  *****************
 * User: Melanie Jutras Date: 12-11-02   Time: 11:47a
